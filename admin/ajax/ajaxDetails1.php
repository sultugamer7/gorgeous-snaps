		...
		<div class="row" style="margin-top: -64px; margin-left: -32px; width: 1168px;">
						...
						<div class="col-md-10" style="padding-left: 5px; ">
							<div class="row">
								...
								';
									if($caption == ''){
										$div1 .= '
											<textarea disabled row="1" column="50" maxlengh="150" class="form-control" style="width: 655px; padding-left: 5px; font-weight: 500; margin-left: -5px; background: white; height: 62.8px; border-radius: 0;" placeholder="No caption..." name="newCaption" id="newCaption" maxlength="150"></textarea>
										';
									}else{
										$div1 .= '
											<textarea disabled row="1" column="50" maxlengh="150" class="form-control" style="padding-left: 5px; width: 655px; margin-left: -5px; height: 62.8px; background: white; border-radius: 0;" placeholder="'.$caption.'" name="newCaption" id="newCaption" maxlength="150"></textarea>
										';
									}
			...
			<div class="col-md-4" style="padding-left: 0; padding-right: 0;">
				...
				<div class="row" style="margin-top: 11px;">
					...
					<a href="profile.php?id='.$id0.'" style="margin-top: 16px; font-size: 20px; margin-left: 10px; font-weight: 500; color: black;">'.$username90.'</a>
				</div>
				...
				";
							if(count($getLikeID) > 0){
								...
								$div1 .= "
									<span style='margin-top: 0px; margin-bottom: 0px; color: red; font-size: 14.7px; margin-left: 4px;'>
										No likes...
									</span>
								";
							}
